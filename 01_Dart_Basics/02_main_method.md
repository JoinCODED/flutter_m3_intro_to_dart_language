Once you open the dartpad, you're gonna see a default code, now we're going to understand it piece by piece. The first thing we're going to understand is **`main`**.
